...
function Intro:onEnter()
	...
	WaitTask(2000):block()
	self:addForeground(Image("/media/intro/face1.png"), VP(0, 0), 0.0, 1.0)
	WaitTask(3000):block()
	self:addForeground(Image("/media/intro/face2.png"), VP(0, 0), 0.0, 1.0)
	WaitTask(3000):block()
	self:addForeground(Image("/media/intro/face3.png"), VP(0, 0), 0.0, 1.0)
	WaitTask(3000):block()
	self:addForeground(Image("/media/intro/face4.png"), VP(0, 0), 0.0, 1.0)
	WaitTask(3000):block()
